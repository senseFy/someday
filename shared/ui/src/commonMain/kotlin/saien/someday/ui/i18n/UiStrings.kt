...
data class NotesUiStrings(
    ...
    val imageImportSourceTooLarge: String = "Choose an image no larger than 32 MB.",
    val imageImportSourcePixelLimitExceeded: String = "The selected image's dimensions are too large.",
    val imageImportUnsupportedFormat: String = "Choose a JPEG, PNG, or WebP image.",
    val imageImportAnimatedImage: String = "Animated images are not supported.",
    val imageImportInvalidEncoding: String = "The selected image is damaged or invalid.",
    val imageImportNormalizationFailed: String = "Unable to prepare the selected image.",
    val imageImportNormalizationQualityLimit: String =
